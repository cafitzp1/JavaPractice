...
public class App {
    public static void main(String[] args) {
        ...
        for (Integer num : commonElements(array1A, array2A)) {
        ...
        for (Integer num : commonElements(array1B, array2B)) {
            System.out.print(num + ", ");
        }
        System.out.println();
        ...
        for (Integer num : commonElements(array1C, array2C)) {
            System.out.print(num + ", ");
        }
        System.out.println();
    ...
    public static Integer[] commonElements(int[] array1, int[] array2) {
        ...
        resultInArray = list.toArray(resultInArray);
